  ...
  return (
    <section className='w-full bg-[#EEF2F7] py-16 flex flex-col items-center px-4'>
      ...
      <div className='mb-6'>
        ...
        <span className='inline-block bg-white rounded-3xl px-6 py-2 font-bold mb-8 text-2xl text-black text-center'>
          WE HELP YOU TO EXPERIENCE
        </span>
      </div>
      {/* Heading */}
      <h2 className='text-center text-2xl md:text-[32px] leading-[40px] max-w-[1200px] text-black mb-12 w-full'>
      ...
      <div className='w-full overflow-x-auto scrollbar-hide'>
        <div className='flex flex-row gap-6 justify-start items-center mb-10 min-w-max px-4 md:justify-center'>
          <Image
            ...
            width={275}
            height={560}
            className='w-[275px] h-[560px] rounded-2xl shadow-lg shrink-0'
          />
          <Image
            ...
            width={345}
            height={703}
            className='w-[345px] h-[703px] rounded-2xl shadow-lg shrink-0'
          />
          <Image
